...
// Re-exported for the modules that have always imported them from here; the
// definitions moved to adapters/exif.ts once a second adapter needed them.
export { captureHour, META_TAGS, num };
