 ...
 * exiftool binary and the ONNX CLIP inference model. Safe to re-run: already-
...
export function registerSetupCommand(program: Command): void {
  program
    .command('setup')
    .description('Download and verify external tools (exiftool) and the inference model into ~/.shoots')
